...
@ Identity
  ...
  ! Guarantee: PeerConnection::new uses webrtc API with default DTLS certificate generation.
  ! Guarantee: SDP offers/answers include certificate fingerprint for DTLS handshake.
