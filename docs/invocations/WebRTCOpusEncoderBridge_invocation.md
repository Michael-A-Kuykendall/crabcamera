...
! Guarantee: OpusWebRTCEncoder produces raw Opus packets.
! Guarantee: frame size is 20ms at configured sample rate.
! Guarantee: timestamps are set by caller for synchronization.
