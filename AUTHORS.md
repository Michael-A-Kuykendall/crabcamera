...
* **Michael A. Kuykendall** - *Creator and primary maintainer*
  - GitHub: [@Michael-A-Kuykendall](https://github.com/Michael-A-Kuykendall)
  - Email: michaelallenkuykendall@gmail.com

## Contributors

CrabCamera follows the 'open source, not open contribution' model. See [CONTRIBUTING.md](CONTRIBUTING.md) for details.
