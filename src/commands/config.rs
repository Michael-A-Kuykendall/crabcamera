...
pub async fn update_config(new_config: CrabCameraConfig) -> Result<String, String> {
    ...
    // Save to file
    new_config.save_to_file(CrabCameraConfig::default_path())
...
pub async fn reset_config() -> Result<CrabCameraConfig, String> {
    ...
    default_config.save_to_file(CrabCameraConfig::default_path())
        .map_err(|e| format!("Failed to save config: {}", e))?;
...
#[command]
pub async fn update_camera_config(camera_config: crate::config::CameraConfig) -> Result<String, String> {
    let mut config = GLOBAL_CONFIG.write()
        .map_err(|e| format!("Failed to write config: {}", e))?;
    ...
    config.save_to_file(CrabCameraConfig::default_path())
        .map_err(|e| format!("Failed to save config: {}", e))?;
...
#[command]
pub async fn update_full_quality_config(quality_config: crate::config::QualityConfig) -> Result<String, String> {
    let mut config = GLOBAL_CONFIG.write()
        .map_err(|e| format!("Failed to write config: {}", e))?;
...
#[command]
pub async fn update_storage_config(storage_config: crate::config::StorageConfig) -> Result<String, String> {
    let mut config = GLOBAL_CONFIG.write()
        .map_err(|e| format!("Failed to write config: {}", e))?;
...
#[command]
pub async fn update_advanced_config(advanced_config: crate::config::AdvancedConfig) -> Result<String, String> {
    let mut config = GLOBAL_CONFIG.write()
        .map_err(|e| format!("Failed to write config: {}", e))?;
