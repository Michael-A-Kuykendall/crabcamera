use tauri::command;
use crate::permissions::{PermissionInfo, PermissionStatus, check_permission_detailed};
...
pub async fn request_camera_permission() -> Result<PermissionInfo, String> {
    ...
    #[cfg(target_os = "windows")]
    {
        ...
        Ok(PermissionInfo {
            ...
            message: "Please enable camera access in Windows Settings > Privacy > Camera".to_string(),
            can_request: false,
        })
    }
